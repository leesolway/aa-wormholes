...
# eve_sde is required by wormholes.WormholeSystem/ShatteredConstellation's FKs.
INSTALLED_APPS += ["eve_sde", "wormholes"]
...
# to https://example.com/sso/callback substituting your domain.
